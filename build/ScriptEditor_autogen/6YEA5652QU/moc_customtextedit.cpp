...
void CustomTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->CloseTagRequested(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CustomTextEdit::*)()>(_a, &CustomTextEdit::CloseTagRequested, 0))
            return;
    }
}
...
// SIGNAL 0
void CustomTextEdit::CloseTagRequested()
{
